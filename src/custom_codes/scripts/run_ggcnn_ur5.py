...
def depth_callback(depth_message):
    ...
    with TimeIt('Inference'):
        ...
        # print("Type antes: ", antes.dtype)
        # print("Depth: ", antes.max())
        # print("Depth_size: ", antes.shape)
        ...
        # No exemplo do gazebo, a media da em torno de 628
        ...
        # depois = depois.astype(np.uint16)
        # print("Type: ", depois.dtype)
        # print("Depth: ", depois.max())
        # print("Depth_size: ", depois.shape)
